...
export const useVideoListStore = defineStore('video-list', {
  ...
  actions: {
    ...
    async komentar_balasan (payload = null) {
      ...
      const results = await axios.get(`http://localhost:8000/api/video/komentar-balasan/${payload.id}?page=${payload.page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async komentar_balasan_more (payload = null) {
      ...
      const results = await axios.get(`http://localhost:8000/api/video/komentar-balasan-more/${payload.id}?page=${next_page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async komentar_balasan_comment (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `http://localhost:8000/api/video/komentar-balasan-comment`,
        data: formData
      })
      .catch(err => {
        errorNotify()
    ...
    async komentar_balasan_delete (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `http://localhost:8000/api/video/komentar-balasan-delete/${payload.id}`,
      })
      .catch(err => {
        errorNotify()
        return null
    ...
    async komentar_semua (payload = null) {
      ...
      const results = await axios.get(`http://localhost:8000/api/video/komentar-semua/${payload.id}?page=${payload.page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async komentar_semua_more (payload = null) {
      ...
      const results = await axios.get(`http://localhost:8000/api/video/komentar-semua/${payload.id}?page=${next_page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async komentar_semua_comment (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `http://localhost:8000/api/video/komentar-semua-comment`,
        data: formData
      })
      .catch(err => {
        errorNotify()
    ...
    async komentar_semua_delete (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `http://localhost:8000/api/video/komentar-semua-delete/${payload.id}`,
      })
      .catch(err => {
        errorNotify()
        return null
