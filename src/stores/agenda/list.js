...
export const useAgendaListStore = defineStore('agenda-list', {
  ...
  actions: {
    ...
    async request (payload = null) {
      ...
      const results = await axios.get(`api/agenda?page=${payload.page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async request_more () {
      ...
      const results = await axios.get(`api/agenda?page=${next_page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async follow (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/follow/${payload.user_id}`,
      })
      .catch(err => {
        errorNotify()
        return null
    ...
    async bookmarked (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/bookmarked/${payload.post_id}`,
      })
      .catch(err => {
        errorNotify()
        return null
    ...
    async liked (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/liked/${payload.post_id}`,
      })
      .catch(err => {
        errorNotify()
        return null
    ...
    async delete (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/delete/${payload.post_id}`,
      })
      .catch(err => {
        errorNotify()
        return null
    ...
    async delete_comment (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/delete-comment/${payload.post_id}`,
        data: formData
      })
      .catch(err => {
        errorNotify()
    ...
    async komentar_balasan (payload = null) {
      ...
      const results = await axios.get(`api/agenda/komentar-balasan/${payload.id}?page=${payload.page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async komentar_balasan_more (payload = null) {
      ...
      const results = await axios.get(`api/agenda/komentar-balasan-more/${payload.id}?page=${next_page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async komentar_balasan_comment (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/komentar-balasan-comment`,
        data: formData
      })
      .catch(err => {
        errorNotify()
    ...
    async komentar_balasan_delete (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/komentar-balasan-delete/${payload.id}`,
      })
      .catch(err => {
        errorNotify()
        return null
    ...
    async komentar_semua (payload = null) {
      ...
      const results = await axios.get(`api/agenda/komentar-semua/${payload.id}?page=${payload.page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async komentar_semua_more (payload = null) {
      ...
      const results = await axios.get(`api/agenda/komentar-semua/${payload.id}?page=${next_page}`)
      .catch(err => {
        errorNotify()
        return null
      })
    ...
    async komentar_semua_comment (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/komentar-semua-comment`,
        data: formData
      })
      .catch(err => {
        errorNotify()
    ...
    async komentar_semua_delete (payload = null) {
      ...
      const results = await axios({
        method: 'post',
        url: `api/agenda/komentar-semua-delete/${payload.id}`,
      })
      .catch(err => {
        errorNotify()
        return null
