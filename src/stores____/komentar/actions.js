...
export async function GET ({ commit, state }, { pull_refresh, segment, id }) {
...
export async function action_payload_more ({ commit, state }, { page, tag }) {

  const results = await axios.get("http://localhost:8000/api/comments"+"?page="+page)
