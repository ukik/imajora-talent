...
export const default_title = 'Cubix - Marketing & Agency | wujudkan impianmu - miliki aset idaman';
export const default_description = 'Pusat jual beli aset properti, ruko, kavling, lahan, material, jasa yang terintegrasi & terpercaya';
export const default_alt = 'Cubix - Marketing & Agency | wujudkan impianmu - miliki aset idaman';
