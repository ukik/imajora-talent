...
<input v-show="false" type="file" name="picture" accept="video/mp4,video/x-m4v,video/*" ref="file" id="file" @change="onFileChange">

<video ref="video" :src="video" id="video-preview" class="col-12" controls>
  <!-- <source ref="video" :src="video" type="video/mp4"> -->
