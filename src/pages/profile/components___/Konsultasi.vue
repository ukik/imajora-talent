<template>
  <div>
      ...
      -->
      <q-item :to="prop_route" clickable v-if="get_layout == 4" class="q-pa-none" v-ripple="{color: 'grey' }">
        ...
        <!-- Simple -->
      <q-item :to="prop_route" clickable v-if="get_layout == 3" class="q-pa-none" v-ripple="{color: 'grey' }">
        ...
        <q-item-section class="q-px-sm">
          ...
          <q-item class="q-pa-none">
            ...
            <q-item-section class="max-width-thumbnail col-5 q-pt-sm">
                <q-img :ratio="16/9"
    ...
    <router-link class="unlink" :to="prop_route">
        ...
        <!-- 2 Column Image -->
        <q-card v-if="get_layout == 0" flat v-ripple="{color: 'grey' }"  class="hover q-px-sm q-pt-sm q-pb-sm  no-border-radius">
        ...
        <!-- 3 Column Image -->
        <q-card v-if="get_layout == 1" flat v-ripple="{color: 'grey' }"  class="hover q-px-sm q-pt-sm q-pb-sm  no-border-radius">
