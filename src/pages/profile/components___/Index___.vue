...
<div>
	...
	<q-item :to="get_route" v-if="get_layout == 0" class="q-pa-none hover" v-ripple="{color: 'grey' }">
	...
	<!-- Simple -->
	<q-item :to="get_route" v-if="get_layout == 1" class="q-pa-none hover" v-ripple="{color: 'grey' }">
	...
	<q-card v-if="get_layout == 2" flat class="q-pt-sm no-border-radius hover">
	...
	<!-- Fullsize LIVE -->
	<q-card v-if="get_layout == 3" flat v-ripple="{color: 'grey' }"  class="q-px-sm q-pt-sm q-pb-xs no-border-radius hover">
	...
	<!-- Fullsize Video -->
	<q-card v-if="get_layout == 4" flat v-ripple="{color: 'grey' }"  class="q-px-sm q-pt-sm no-border-radius hover">
	...
	<!-- Fullsize Image -->
	<q-card v-if="get_layout == 5" flat v-ripple="{color: 'grey' }"  class="q-px-sm q-pt-sm q-pb-xs no-border-radius hover">
	...
	<!-- 2 Column Image -->
	<q-card v-if="get_layout == 6" flat v-ripple="{color: 'grey' }"  class="q-px-sm q-pt-sm q-pb-sm  no-border-radius hover">
	...
	<!-- 3 Column Image -->
	<q-card v-if="get_layout == 7" flat v-ripple="{color: 'grey' }"  class="q-px-sm q-pt-sm q-pb-sm  no-border-radius hover">
...
export default {
	...
	computed: {		
		get_konsultasi() {
			if(this.prop_item.konsultasi) return this.prop_item.konsultasi.id			
			return
		},
		get_route() {
			switch(this.prop_item.tipe_to_label) {
				case "artikel":
					return {
						name: 'artikel_detail',
						params: {
							id: this.prop_item.id
						}
					}
				case "gambar":
					return {
				...
				case "jawaban_konsultasi":
					...
					// 	params: {
					// 		// :id_konsultasi/:id",
					// 		id_konsultasi: this.prop_item.id_konsultasi,
					// 		id: this.prop_item.id
					// 	}
					// }				
				case "konsultasi":
