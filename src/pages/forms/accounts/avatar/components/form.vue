<template>
  ...
  <q-card v-for="(item, i) in cover" flat square v-if="cover.length > 0" class="col-12 row q-mb-md">
    ...
    <q-img ref="cover" style="object-fit: cover; height: auto;" :src="item?.file"
      loading="lazy">
