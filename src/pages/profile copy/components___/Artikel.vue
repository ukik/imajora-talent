...
<div>
  ...
  <q-card v-if="get_layout == 2" flat v-ripple="{color: 'grey' }" class="hover q-pt-sm no-border-radius">
  ...
  <q-card v-if="get_layout == 5" flat v-ripple="{color: 'grey' }"  class="hover q-pt-sm q-pb-xs no-border-radius">
  ...
  <!-- Fullsize Image -->
  <q-card v-if="get_layout == 6" flat v-ripple="{color: 'grey' }"  class="hover q-px-sm q-pt-sm q-pb-xs no-border-radius">
  ...
  <!-- 3 Column Image -->
  <q-card v-if="get_layout == 8" flat v-ripple="{color: 'grey' }"  class="hover q-px-sm q-pt-sm q-pb-sm  no-border-radius">
